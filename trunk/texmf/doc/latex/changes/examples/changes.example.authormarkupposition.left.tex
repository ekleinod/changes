%%
%% This is file `changes.example.authormarkupposition.left.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:authormarkupposition:left')
%% 
%% changes.dtx
...
%%
%% End of file `changes.example.authormarkupposition.left.tex'.
