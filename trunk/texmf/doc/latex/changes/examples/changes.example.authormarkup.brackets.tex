%%
%% This is file `changes.example.authormarkup.brackets.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:authormarkup:brackets')
%% 
%% changes.dtx
...
%%
%% End of file `changes.example.authormarkup.brackets.tex'.
