%%
%% This is file `changes.example.setauthormarkupposition.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:setauthormarkupposition')
%% 
%% changes.dtx
...
%%
%% End of file `changes.example.setauthormarkupposition.tex'.
