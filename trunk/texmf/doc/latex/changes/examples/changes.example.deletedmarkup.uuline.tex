%%
%% This is file `changes.example.deletedmarkup.uuline.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:deletedmarkup:uuline')
%% 
%% changes.dtx
...
%%
%% End of file `changes.example.deletedmarkup.uuline.tex'.
