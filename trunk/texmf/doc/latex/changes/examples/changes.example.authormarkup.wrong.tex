%%
%% This is file `changes.example.authormarkup.wrong.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:authormarkup:wrong')
%% 
%% changes.dtx
...
%%
%% End of file `changes.example.authormarkup.wrong.tex'.
