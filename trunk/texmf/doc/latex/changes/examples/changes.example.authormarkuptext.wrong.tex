%%
%% This is file `changes.example.authormarkuptext.wrong.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:authormarkuptext:wrong')
%% 
%% changes.dtx
...
%%
%% End of file `changes.example.authormarkuptext.wrong.tex'.
