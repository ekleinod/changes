%%
%% This is file `changes.example.addedmarkup.uwave.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:addedmarkup:uwave')
%% 
%% changes.dtx
...
%%
%% End of file `changes.example.addedmarkup.uwave.tex'.
