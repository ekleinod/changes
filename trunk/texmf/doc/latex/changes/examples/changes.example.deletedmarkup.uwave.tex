%%
%% This is file `changes.example.deletedmarkup.uwave.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:deletedmarkup:uwave')
%% 
%% changes.dtx
...
%%
%% End of file `changes.example.deletedmarkup.uwave.tex'.
