%%
%% This is file `changes.example.setauthormarkuptext.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:setauthormarkuptext')
%% 
%% changes.dtx
...
%%
%% End of file `changes.example.setauthormarkuptext.tex'.
