%%
%% This is file `changes.example.authormarkup.none.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:authormarkup:none')
%% 
%% changes.dtx
...
%%
%% End of file `changes.example.authormarkup.none.tex'.
