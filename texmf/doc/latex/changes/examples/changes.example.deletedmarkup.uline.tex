%%
%% This is file `changes.example.deletedmarkup.uline.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:deletedmarkup:uline')
%% 
%% changes.dtx
...
%%
%% End of file `changes.example.deletedmarkup.uline.tex'.
