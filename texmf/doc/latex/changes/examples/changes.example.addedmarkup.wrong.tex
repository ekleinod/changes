%%
%% This is file `changes.example.addedmarkup.wrong.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:addedmarkup:wrong')
%% 
%% changes.dtx
...
%%
%% End of file `changes.example.addedmarkup.wrong.tex'.
