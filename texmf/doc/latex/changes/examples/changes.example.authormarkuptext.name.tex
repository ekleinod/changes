%%
%% This is file `changes.example.authormarkuptext.name.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:authormarkuptext:name')
%% 
%% changes.dtx
...
%%
%% End of file `changes.example.authormarkuptext.name.tex'.
