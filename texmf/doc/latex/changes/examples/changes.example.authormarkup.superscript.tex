%%
%% This is file `changes.example.authormarkup.superscript.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:authormarkup:superscript')
%% 
%% changes.dtx
...
%%
%% End of file `changes.example.authormarkup.superscript.tex'.
