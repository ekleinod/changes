%%
%% This is file `changes.example.addedmarkup.uline.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:addedmarkup:uline')
%% 
%% changes.dtx
...
%%
%% End of file `changes.example.addedmarkup.uline.tex'.
