%%
%% This is file `changes.example.authormarkupposition.wrong.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:authormarkupposition:wrong')
%% 
%% changes.dtx
...
%%
%% End of file `changes.example.authormarkupposition.wrong.tex'.
