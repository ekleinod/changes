%%
%% This is file `changes.example.deletedmarkup.dashuline.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:deletedmarkup:dashuline')
%% 
%% changes.dtx
...
%%
%% End of file `changes.example.deletedmarkup.dashuline.tex'.
