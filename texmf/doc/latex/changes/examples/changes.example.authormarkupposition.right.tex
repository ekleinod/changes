%%
%% This is file `changes.example.authormarkupposition.right.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:authormarkupposition:right')
%% 
%% changes.dtx
%% Copyright 2007-2011 Ekkart Kleinod (ekleinod@edgesoft.de)
%% 
...
%%
%% End of file `changes.example.authormarkupposition.right.tex'.
