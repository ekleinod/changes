%%
%% This is file `changes.example.listofchanges.wrong.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:listofchanges:wrong')
%% 
%% changes.dtx
...
%%
%% End of file `changes.example.listofchanges.wrong.tex'.
