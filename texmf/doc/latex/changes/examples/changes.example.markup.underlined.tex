%%
%% This is file `changes.example.markup.underlined.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:markup:underlined')
%% 
%% changes.dtx
...
%%
%% End of file `changes.example.markup.underlined.tex'.
