%%
%% This is file `changes.example.deletedmarkup.dotuline.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:deletedmarkup:dotuline')
%% 
%% changes.dtx
...
%%
%% End of file `changes.example.deletedmarkup.dotuline.tex'.
