%%
%% This is file `changes.example.authormarkup.subscript.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:authormarkup:subscript')
%% 
%% changes.dtx
...
%%
%% End of file `changes.example.authormarkup.subscript.tex'.
