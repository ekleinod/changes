%%
%% This is file `changes.example.deletedmarkup.xout.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:deletedmarkup:xout')
%% 
%% changes.dtx
...
%%
%% End of file `changes.example.deletedmarkup.xout.tex'.
