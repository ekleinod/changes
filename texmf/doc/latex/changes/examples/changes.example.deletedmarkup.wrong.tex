%%
%% This is file `changes.example.deletedmarkup.wrong.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:deletedmarkup:wrong')
%% 
%% changes.dtx
...
%%
%% End of file `changes.example.deletedmarkup.wrong.tex'.
