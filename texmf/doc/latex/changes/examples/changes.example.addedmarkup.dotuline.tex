%%
%% This is file `changes.example.addedmarkup.dotuline.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:addedmarkup:dotuline')
%% 
%% changes.dtx
...
%%
%% End of file `changes.example.addedmarkup.dotuline.tex'.
