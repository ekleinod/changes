%%
%% This is file `changes.example.authormarkuptext.id.tex',
%% generated with the docstrip utility.
%%
%% The original source files were:
%%
%% examples.dtx  (with options: `example:authormarkuptext:id')
%% 
%% changes.dtx
...
%%
%% End of file `changes.example.authormarkuptext.id.tex'.
