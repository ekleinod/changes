...
\ifENGLISH
	...
	You have to define a unique author-id, special characters or spaces are not allowed in the author-id.
	...
	\begin{einspiel}
		\>\chcommand{definechangesauthor[name=\{author's name\}, color=\{color\}]\{\meta{author-id}\}}
	\end{einspiel}
\fi
	\ifGERMAN
		...
		\begin{einspiel}
			\>\chcommand{definechangesauthor[name=\{Autor-Name\}, color=\{Farbe\}]\{\meta{Autor-ID}\}}
		\end{einspiel}
	\fi
\begin{einspiel}[true]
