...
%^^A new language example: french
%^^A \newif\ifFRENCH\FRENCHfalse
%^^A \iflanguage{french}{\FRENCHtrue}{\ENGLISHfalse}
...
\ifGERMAN
 ...
 \begin{einspiel}[true]
	...
	\>Das ist \replaced[EK]{schöner\fi
\ifGERMANschlechter} Text.
 \end{einspiel}
}
%
...
%
 Copyright 2007-2010 Ekkart Kleinod (\href{mailto:ekkart@ekkart.de\fi
\ifGERMANekkart@ekkart.de})
%
